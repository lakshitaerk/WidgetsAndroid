...
class MyAppWidgetReceiverLarge : GlanceAppWidgetReceiver() {

    override val glanceAppWidget: GlanceAppWidget = MyAppWidgetLarge()
}

class MyAppWidgetLarge : GlanceAppWidget() {
